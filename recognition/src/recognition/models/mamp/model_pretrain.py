...
class TransformerMAMP(nn.Module):
    def __init__(
        self,
        dim_in=3,
        dim_feat=256,
        ...
        trunc_normal_(self.decoder_temp_embed, std=0.02)
    ...
    def forward(self, x, **kwargs):
        ...
        x_motion = self.extract_motion(x, self.motion_stride)
        latent, mask, ids_restore = self.forward_encoder(x, self.mask_ratio, self.motion_aware_tau)
